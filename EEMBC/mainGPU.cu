...
__device__ varsize tonewheelTeeth =60;
...
__device__ void WriteOut(varsize value,varsize* output);

__device__ void a2time(varsize in1,varsize pulseDeltaTime1, 
                varsize angle1, 
                varsize angleCounterLast1,
                varsize toothCount1, 
                varsize deltaTimeAccum1,
...
__device__ void rdspeed(varsize tonewheelCounter1, varsize toothDeltaTime1, varsize toothDeltaTimeLast1, varsize tonewheelCounterLast1, long toothTimeAccum1, varsize toothCount1, varsize *roadSpeed1){
...
__device__ void aifftr01(varsize realData_1[NUM_POINTS], varsize imagData_1[NUM_POINTS])    /* Points to imaginary part of data */
{
...
__device__ short unPack( unsigned char c )
{        
...
__device__ void idctrno1(unsigned char inChar[ROWS + COLS],signed char f_1[ROWS][COLS])
{
...
__device__ void puwmod01(varsize commandPos, int upDirection1,
 int lastDirection1,
 int enbPhaseA1,
 int dirPhaseA1,
 int enbPhaseB1,
...
__device__ const varsize engLoadROM[] =
{
...
__device__ const varsize engSpeedROM[] =
{
...
__device__ const varsize angleTableROM[] =
{
...
__device__ void tblook01(varsize loadValue, varsize speedValue, varsize *outResult )
{
